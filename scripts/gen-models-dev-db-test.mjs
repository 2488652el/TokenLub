 ...
 * rate (src/shared/utils/money.ts DEFAULT_CNY_RATES.USD = 7.0511), matching the
...
// --- TokenScope provider mapping (mirror of src/main/pricing/catalog.ts PROVIDER_MAPPING) ---
...
// --- exchange rate: project default USD→CNY (src/shared/utils/money.ts DEFAULT_CNY_RATES.USD) ---
// 汇率:项目默认美元→人民币(src/shared/utils/money.ts DEFAULT_CNY_RATES.USD)
...
const summary = {
  source: {
    ...
    note:
      ...
      'This differs from src/main/pricing/catalog.ts which reads a different models.dev endpoint ' +
  ...
  currency_conversion: {
    ...
    target_currency: 'CNY',
    rate: USD_TO_CNY,
    rate_source: 'src/shared/utils/money.ts DEFAULT_CNY_RATES.USD (项目默认汇率兜底值)',
    note:
