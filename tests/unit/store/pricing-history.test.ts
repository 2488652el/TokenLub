...
import type { PricingDiffEntry } from '../../../src/shared/types/pricing'
...
vi.mock('../../../src/main/store/db', () => ({ getDb: () => db }))
vi.mock('../../../src/main/store/sync-v2-repo', () => ({ markSyncV2Dirty: vi.fn() }))

import { listPricingHistory, recordPricingHistory } from '../../../src/main/store/pricing-repo'
